...
#     def price_change_colored(self, obj):
#         """Show colored percentage change (green/red)."""
#         raw_change = obj.get_change_percentage or 0
#         change = self.as_decimal(raw_change)
...
class StockAdmin(admin.ModelAdmin):
    ...
    list_display_links = ('symbol', 'name')
    # you can edit min_quantity directly in list view if you like:
    ...
    fieldsets = (
        ("Basic Info", {"fields": ("symbol", "name", "min_quantity")}),
        ("Price Details", {
            "fields": (
                "open_price", "high_price", "low_price",
                "close_price", "current_price",
